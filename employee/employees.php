...
if (isset($_GET['del'])) {
    ...
    $_SESSION['msg'] = '<script src="../alertjs/all.js"></script>       
        <script>
            ...
            alertify.error("An Employee Has deleted Successfully");               
        </script>';
}
if (isset($_POST['save_manufacturer'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql1 = "INSERT INTO manufacturer (manufacturer_name, description, type)
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr>                                      
                                                ...
                                                <td>                                                      
                                                    <a  tittle="Remove Products" href="employees.php?id=<?php echo $row['employee_id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><button type="button" class="btn btn-danger btn-sm">delete</button></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
