            ...
            <div class="col-sm-9 my-2">                
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addspare">
                            Add New Spare
                        </button>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr>                                      
                                            ...
                                            <td>    
                                                <a class="btn btn-primary btn-sm" href="spareinfo.php?id=<?php echo $row['spare_id']; ?>">More</a>
                                                <a class="btn btn-success btn-sm" href="spareedit.php?id=<?php echo $row['spare_id']; ?>">Edit</a>
                                                <a  tittle="Remove Products" href="spares.php?id=<?php echo $row['spare_id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><button type="button" class="btn btn-danger btn-sm">delete</button></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
